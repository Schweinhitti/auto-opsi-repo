...
commits, code, wiki edits, issues, and other contributions that aren't aligned with this Code
...
to the maintainers through
[GitHub private reporting](https://github.com/Schweinhitti/auto-opsi-repo/security/advisories/new).
State that the report concerns conduct rather than a software vulnerability. All complaints
